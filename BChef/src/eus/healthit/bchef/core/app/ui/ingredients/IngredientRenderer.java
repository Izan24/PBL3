...
public class IngredientRenderer implements ListCellRenderer<Ingredient> {

	@Override
	public Component getListCellRendererComponent(JList<? extends Ingredient> list, Ingredient value, int index,
		...
		JLabel ingredientText = new JLabel(value.getName());
		JLabel ingredient = new JLabel(value.getQuantity());
