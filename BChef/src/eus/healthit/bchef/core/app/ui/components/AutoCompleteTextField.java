...
public class AutoCompleteTextField extends JTextField implements KeyListener, DocumentListener {
	...
	/**
	 * Constructs a new AutoCompleteTextField with the 5 columns by default and no
	...
	/**
	 * Constructs a new AutoCompleteTextField with the specified number of columns
	 * with no case sensitivity when comparing the current guess to the text
	 * entered.
	 * 
	...
	/**
	 * Creates a new AutoCompleteTextField with the given number of columns in width
	 * and the setting for case sensitivity when comparing the current guess to the
	 * entered text.
	 * 
	 * @param columns       The number of columns of text for this component.
	 * @param caseSensitive <code>true</code> or <code>false</code> depending on if
	 *                      you want comparisons to be case sensitive or not.
	 */
	...
	/**
	 * Add a new possibility to the list of possibilities. Add a new possibility to
	 * the list of possibilities for the AutoCommpleteTextField to process.
	 * 
	...
	/**
	 * Removes all possibilities in the list. Removes every possibility in the list
	 * and starts over with an empty list ready for new possibilities to be added.
	 */
	...
	/**
	 * Sets the color to draw the incomplete guess in. This sets the color that the
	 * incomplete guess text is drawn in.
	 * 
	...
	/**
	 * Returns the current guess from the list of possibilities. Returns the string
	 * at the location of the current guess in the list of possibilities.
	 * 
